...
class TestOpenflowControllerStub(unittest2.TestCase):
    ...
    def test_get_stats_flow(self):
        ...
        def _callback(flow_stats, reply_more,
        ...
        flow_stats2 = ofstats.FlowStats(
            ...
            0xffeeddccbbaa9988, 0x42, 0x0153, ())
        self.peerproto.send_stats_reply_flow(2, (flow_stats1,),
                                             reply_more=True)
    ...
    def test_get_stats_aggregate(self):
        ...
        def _callback(packet_count, byte_count, flow_count,
                      callbacks_made=self.callbacks_made):
            callbacks_made.append(('get_stats_aggregate', packet_count,
        ...
        self.assertItemsEqual(
            [('get_stats_aggregate', 0x1234, 0x1324, 0x0123)],
            self.callbacks_made)
    ...
    def test_get_stats_table(self):
        ...
        def _callback(table_stats, reply_more,
                      callbacks_made=self.callbacks_made):
        ...
        table_stats2 = ofstats.TableStats(
            ...
            0x9abcd)
        self.peerproto.send_stats_reply_table(2, (table_stats1,),
                                              reply_more=True)
    ...
    def test_get_stats_port(self):
        ...
        def _callback(port_stats, reply_more,
                      callbacks_made=self.callbacks_made):
        ...
        # Sent OFPT_STATS_REQUEST with XID 2.
        self.assertTupleEqual(
            ('handle_stats_request_port', 2, ofproto.OFPP_NONE),
            self._get_next_sent_message())

        # Send 2 OFPT_STATS_REPLY messages to answer the request.
        port_stats1 = ofstats.PortStats(
            port_no=0xab01, rx_packets=0x1234, tx_packets=0x5678,
            rx_bytes=0x1324, tx_bytes=0x5768, rx_dropped=0x1a2b,
            tx_dropped=0x3c4d, rx_errors=0xab12, tx_errors=0xcd34,
            rx_frame_err=0x1432, rx_over_err=0x2543,
            rx_crc_err=0x3654, collisions=0x4765)
        port_stats2 = ofstats.PortStats(
            port_no=0xab02, rx_packets=0x1234, tx_packets=0x5678,
            rx_bytes=0x1324, tx_bytes=0x5768, rx_dropped=0x1a2b,
            tx_dropped=0x3c4d, rx_errors=0xab12, tx_errors=0xcd34,
            rx_frame_err=0x1432, rx_over_err=0x2543,
            rx_crc_err=0x3654, collisions=0x4765)
        self.peerproto.send_stats_reply_port(2, (port_stats1,),
                                             reply_more=True)
    ...
    def test_get_stats_queue(self):
        ...
        def _callback(queue_stats, reply_more,
                      callbacks_made=self.callbacks_made):
        ...
        # Sent OFPT_STATS_REQUEST with XID 2.
        self.assertTupleEqual(
            ('handle_stats_request_queue', 2, ofproto.OFPP_ALL,
             ofproto.OFPQ_ALL),
            self._get_next_sent_message())

        # Send 2 OFPT_STATS_REPLY messages to answer the request.
        queue_stats1 = ofstats.QueueStats(
            port_no=0xab01, queue_id=0x11111111, tx_bytes=0x5768,
            tx_packets=0x5678, tx_errors=0xcd34)
        queue_stats2 = ofstats.QueueStats(
            port_no=0xab01, queue_id=0x22222222, tx_bytes=0x5768,
            tx_packets=0x5678, tx_errors=0xcd34)
        self.peerproto.send_stats_reply_queue(2, (queue_stats1,),
                                              reply_more=True)
    ...
    def test_get_stats_queue_stats_type_mismatch(self):
        ...
        # An OFPET_BAD_REQUEST / OFPBRC_BAD_TYPE error has been sent
        # back, with the same XID.
        self.assertTupleEqual(
            ('handle_error', 2,
    ...
    def test_handle_port_status_add(self):
        ...
        # Send the OFPT_FEATURES_REPLY message to complete the
        # handshake, with only phyport1.
        self.peerproto.send_features_reply(1, self.features1)
    ...
    def test_handle_port_status_delete(self):
        ...
        # Send the OFPT_FEATURES_REPLY message to complete the
        # handshake, with both phyport1 and phyport2.
    ...
    def test_handle_port_status_modify(self):
        ...
        # The features has been updated.
        self.assertEqual(self.features1._replace(ports=(p,)),
                         self.proto.features)
    ...
    def test_termination_bad_type(self):
        ...
        # Answer the OFPT_ECHO_REQUEST with a OFPT_BARRIER_REPLY with
        # the same XID.
