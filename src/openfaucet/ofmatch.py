...
class Wildcards(collections.namedtuple('Wildcards', (
  ...
  All attributes (except nw_src and nw_dst) are booleans, and have the
  same names and indexes as the attributes in class Match. If an
...
class Match(collections.namedtuple('Match', (
  ...
  def deserialize(cls, buf):
    ...
    (wildcards_ser, in_port, dl_src, dl_dst, dl_vlan, dl_vlan_pcp, dl_type,
     nw_tos, nw_proto, nw_src, nw_dst, tp_src, tp_dst) = buf.unpack(cls.FORMAT)
